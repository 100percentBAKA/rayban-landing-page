    ...
    .forEach(function (ele) {
        ...
        document.querySelector('#main')
            .addEventListener("click", function () {
                ...
                index === all_h1.length - 1 ? index = 0 : index++;
